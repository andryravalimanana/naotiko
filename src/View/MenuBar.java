...
public class MenuBar extends JMenuBar{
    ...
    private void initialiseComponent(){
        ...
        copyMenuItem = new JMenuItem("Kaopia", new ImageIcon(MenuBar.class.getResource("/img/copy.png")));
        cutMenuItem = new JMenuItem("Hafindra", new ImageIcon(MenuBar.class.getResource("/img/cut.png")));
        pasteMenuItem = new JMenuItem("Hametaka", new ImageIcon(MenuBar.class.getResource("/img/paste.png")));
        editNoteMenuItem = new JMenuItem("Hanova Naoty", new ImageIcon(MenuBar.class.getResource("/img/edit.png")));
        //initialise view items
        statisticMenuItem = new JMenuItem("Statisitika", new ImageIcon(MenuBar.class.getResource("/img/stat.png")));
        ConfigMenuItem = new JMenuItem("Kaonfigy", new ImageIcon(MenuBar.class.getResource("/img/config.png")));
        // initialise about items
        developpersMenuItem = new JMenuItem("Nikaody", new ImageIcon(MenuBar.class.getResource("/img/author.png")));
        naotikoMenuItem = new JMenuItem("Naotiko", new ImageIcon(MenuBar.class.getResource("/img/naotiko.png")));
    }
